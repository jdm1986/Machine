    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Machine.MachineContext>
    {
        ...
        protected override void Seed(Machine.MachineContext context)
        {
            ...
            context.Machines.AddOrUpdate(
                ...
                new Mach { MachineId = 5, MachineNum = 734, MachineMake = "CAT", MachineModel = "D8", Hours = 4500, Status = false},
                new Mach { MachineId = 6, MachineNum = 823, MachineMake = "CAT", MachineModel = "D9", Hours = 6500, Status = false}
